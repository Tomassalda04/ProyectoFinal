    ...
    , m_derechaPresionada(false)
{
    ...
    connect(m_timerMovimiento, &QTimer::timeout,
            this, &NaveEspacial::actualizarPaso);
...
// 🔹 NUEVO: reactivar el movimiento después de haber llamado a detener()
...
void NaveEspacial::actualizarPaso()
{
    ...
    // Integración de movimiento (usa la física de Personaje)
...
void NaveEspacial::actualizarCamara()
{
    ...
    QPointF centro = pos();
    // Pequeño offset a la derecha para que se vea "más nivel por delante"
