...
void Jugador::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->coheteRecolectado((*reinterpret_cast< std::add_pointer_t<QGraphicsItem*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Jugador::*)(QGraphicsItem * );
            if (_q_method_type _q_method = &Jugador::coheteRecolectado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Jugador::coheteRecolectado(QGraphicsItem * _t1)
{
